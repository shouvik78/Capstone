...
<div style="background-color:#476b6b" class="container-fluid red-background size">
	<div class="row">
...
<div class="container size">
	...
	<option value="">-- Select --</option><optgroup title="Uttar Pradesh" label="&raquo; Uttar Pradesh"></optgroup><option value="Kanpur" >Kanpur</option><option value="Prayagraj" >Prayagraj</option><option value="Vanaras" >Vanaras</option><option value="Mirzapur" >Mirzapur</option><option value="Muzaffarnager" >Muzaffarnagaer</option><option value="Noida" >Noida</option><option value="Lukhnow" >Lukhnow</option><option value="Sudhnati" >Sudhnati</option><optgroup title="Panjab" label="&raquo; Panjab"></optgroup><option value="Phagwara" >Phagwara</option><option value="Jalandhar" >Jalandhar</option><option value="Patiala" >Patiala</option><option value="Amritsar" >Amritsar</option><option value="Ludhiana" >Ludhiana</option><option value="Mohali" >Mohali</option><option value="Padhankot" >Pathankot</option><option value="Firazpur" >Firozpur</option><option value="Moga" >Moga</option></select>
            </div><!--city end-->
            <div class="form-group">
